...
class _ProductDetailsApiService implements ProductDetailsApiService {
  _ProductDetailsApiService(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  @override
  Future<List<Product>> getProductDetails(int productId) async {
  ...
  Future<ProductAddOns> getProductAddons(int productId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'product_id2': productId};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ProductAddOns>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'proaddon/v1/get2',
    ...
    late ProductAddOns _value;
    try {
      _value = ProductAddOns.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
