...
class _CartApiServices implements CartApiServices {
  ...
  @override
  Future<GuestCartResponse> getGuestCart(String guestId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'guest_id': guestId};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GuestCartResponse>(
    ...
    late GuestCartResponse _value;
    try {
      _value = GuestCartResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
